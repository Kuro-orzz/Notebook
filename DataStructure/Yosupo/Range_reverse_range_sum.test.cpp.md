...
data:
  ...
  bundledCode: "#line 1 \"DataStructure/Yosupo/Range_reverse_range_sum.test.cpp\"\n\
    ...
    \       n = a.size() - 1;\n        rebuild();\n    }\n};\n#line 5 \"DataStructure/Yosupo/Range_reverse_range_sum.test.cpp\"\
    \n\nvoid solve() {\n    int n, q; cin >> n >> q;\n    vector<int> a(n + 1);\n\
    \    for (int i = 1; i <= n; i++) {\n        cin >> a[i];\n    }\n    Sqrt sqrt(n,\
  ...
  verifiedWith: []
documentation_of: DataStructure/Yosupo/Range_reverse_range_sum.test.cpp
layout: document
redirect_from:
- /verify/DataStructure/Yosupo/Range_reverse_range_sum.test.cpp
- /verify/DataStructure/Yosupo/Range_reverse_range_sum.test.cpp.html
