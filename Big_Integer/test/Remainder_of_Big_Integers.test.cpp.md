...
data:
  ...
  bundledCode: "#line 1 \"Big_Integer/test/Remainder_of_Big_Integers.test.cpp\"\n\
    ...
    \ out;\n    }\n};\n#line 5 \"Big_Integer/test/Remainder_of_Big_Integers.test.cpp\"\
    \n\nvoid solve() {\n\tBigInt a, b; cin >> a >> b;\n\tcout << a % b << '\\n';\n\
    }\n"
...
layout: document
redirect_from:
- /verify/Big_Integer/test/Remainder_of_Big_Integers.test.cpp
- /verify/Big_Integer/test/Remainder_of_Big_Integers.test.cpp.html
