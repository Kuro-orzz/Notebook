...
data:
  ...
  bundledCode: "#line 1 \"Big_Integer/Yosupo/Addition_of_Big_Integers.test.cpp\"\n\
    ...
    \ + z1.shifted(k) + z0;\n        res.neg = (a.neg != b.neg);\n        res.trim();\n\
    \        return res;\n    }\n\n    BigInt operator*(const BigInt &b) const {\n\
    \        return karatsuba(*this, b);\n    }\n};\n#line 5 \"Big_Integer/Yosupo/Addition_of_Big_Integers.test.cpp\"\
    \n\nvoid solve(){\n    int t; cin >> t;\n    while (t--) {\n        string s1,\
    \ s2; cin >> s1 >> s2;\n        BigInt a(s1), b(s2);\n        cout << a + b <<\
    \ '\\n';\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: Big_Integer/Yosupo/Addition_of_Big_Integers.test.cpp
layout: document
redirect_from:
- /verify/Big_Integer/Yosupo/Addition_of_Big_Integers.test.cpp
- /verify/Big_Integer/Yosupo/Addition_of_Big_Integers.test.cpp.html
